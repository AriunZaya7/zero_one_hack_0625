# Solution 0: Rule Mock Baseline - Industrial AI Report

## TL;DR

Deliberately simple baseline and submission-shape proof. It produces the three required Industrial AI eval CSV
shapes and reports local scores for next-step prediction, sequence
completion, and anomaly detection. Baseline/mock. Task 3 is an oracle validator, not learned anomaly detection.
...
to `solutions/solution_0_rule_mock/outputs/`.
...
- **Task 1 exact Top-1:** `0.6800`
- **Task 1 exact Top-3:** `0.9883`
