# Solution 1: Hybrid Retrieval - Industrial AI Report

## TL;DR

Retrieval baseline for stronger completion quality. It produces the three required Industrial AI eval CSV
shapes and reports local scores for next-step prediction, sequence
completion, and anomaly detection. Stronger than n-gram completion, but still not a trained neural model.
...
to `solutions/solution_1_hybrid_retrieval/outputs/`.
