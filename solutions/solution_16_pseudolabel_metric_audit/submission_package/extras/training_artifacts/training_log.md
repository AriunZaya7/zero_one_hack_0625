...
No binary checkpoint is needed; pseudo labels and metric logs are regenerated deterministically from the released participant files and validator. For a real neural submission, this folder should be
