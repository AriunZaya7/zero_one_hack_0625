...
No binary checkpoint is needed; calibration tables and guard audit files are regenerated deterministically from public data and released participant files. For a real neural submission, this folder should be
