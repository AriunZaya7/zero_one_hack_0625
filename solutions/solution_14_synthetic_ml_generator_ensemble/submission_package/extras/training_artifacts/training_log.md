...
No binary checkpoint is needed; generated training data and count tables are rebuilt deterministically from source. For a real neural submission, this folder should be
