# Solution 14: Synthetic ML Generator Ensemble Submission Package
...
The command rewrites the source outputs in `solutions/solution_14_synthetic_ml_generator_ensemble/outputs/`.
