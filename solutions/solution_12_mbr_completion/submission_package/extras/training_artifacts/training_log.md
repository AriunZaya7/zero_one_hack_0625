...
No binary checkpoint is needed; all selected specialists and the MBR candidate-risk decoder rebuild deterministically. For a real neural submission, this folder should be
