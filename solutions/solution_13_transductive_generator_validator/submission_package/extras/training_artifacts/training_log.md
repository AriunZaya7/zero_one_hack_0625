...
No binary checkpoint is needed; the model is rebuilt from the participant inputs, validator, and deterministic fallback source. For a real neural submission, this folder should be
