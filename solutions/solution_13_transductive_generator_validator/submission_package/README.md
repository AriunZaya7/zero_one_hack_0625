# Solution 13: Transductive Generator Validator Submission Package
...
The command rewrites the source outputs in `solutions/solution_13_transductive_generator_validator/outputs/`.
...
Transductive upper-bound candidate. It is very strong on the released files because Task 3 contains full valid routes matching every Task 1/2 partial; this is not a normal generalization claim.
