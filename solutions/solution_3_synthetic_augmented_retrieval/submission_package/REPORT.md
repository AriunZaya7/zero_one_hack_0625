# Solution 3: Synthetic-Augmented Retrieval - Industrial AI Report

## TL;DR

Best seed-42 in-distribution attempt so far. It produces the three required Industrial AI eval CSV
shapes and reports local scores for next-step prediction, sequence
completion, and anomaly detection. Good in-distribution metrics; weaker IC leave-one-family-out proxy.
...
to `solutions/solution_3_synthetic_augmented_retrieval/outputs/`.
