# Solution 5: Tuned Rank Ensemble - Industrial AI Report

## TL;DR

Task 1 rank-weighting ablation. It produces the three required Industrial AI eval CSV
shapes and reports local scores for next-step prediction, sequence
completion, and anomaly detection. Useful ablation; does not beat Solution 3 in-distribution or Solution 2/4 on LOFO.
...
to `solutions/solution_5_tuned_rank_ensemble/outputs/`.
...
- **Task 1 exact Top-1:** `0.7300`
- **Task 1 exact Top-3:** `1.0000`
- **Task 1 exact Top-5:** `1.0000`
- **Task 1 MRR:** `0.8642`
- **Canonical process-step Top-1:** `0.9750` local diagnostic
