...
No binary checkpoint is needed; conformance rules and retrieval tables are rebuilt deterministically. For a real neural submission, this folder should be
