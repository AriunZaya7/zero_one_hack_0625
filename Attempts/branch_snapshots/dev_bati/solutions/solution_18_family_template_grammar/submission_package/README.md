# Solution 18: Family-Template Grammar Submission Package
...
The command rewrites the source outputs in `solutions/solution_18_family_template_grammar/outputs/`.
...
Submit-ready OOD-oriented candidate. Current official rows still all use exact route matching; the new value is a stronger hidden-family fallback when exact strings are derivable from the visible family name.
