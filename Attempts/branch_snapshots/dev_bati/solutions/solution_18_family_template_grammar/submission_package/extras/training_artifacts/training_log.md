...
No binary checkpoint is needed; exact-route memory, synthetic template routes, and retrieval indexes are regenerated deterministically from source. For a real neural submission, this folder should be
