# Solution 4: Length-Aware Completion - Industrial AI Report

## TL;DR

Metric tradeoff attempt for Task 2 suffix length. It produces the three required Industrial AI eval CSV
shapes and reports local scores for next-step prediction, sequence
completion, and anomaly detection. Improves block alignment slightly but worsens normalized edit distance.
...
to `solutions/solution_4_length_aware_completion/outputs/`.
