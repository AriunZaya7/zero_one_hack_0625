...
No binary checkpoint is needed; full-route memory, valid-partial lattice, paired-length statistics, template routes, and retrieval indexes are regenerated deterministically from source. For a real neural submission, this folder should be
