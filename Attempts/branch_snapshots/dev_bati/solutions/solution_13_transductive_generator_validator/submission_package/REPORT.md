# Solution 13: Transductive Generator Validator - Industrial AI Report

## TL;DR

Upper-bound participant-input strategy using validator-valid full routes as exact completion candidates. It produces the three required Industrial AI eval CSV
shapes and reports local scores for next-step prediction, sequence
completion, and anomaly detection. Transductive upper-bound candidate. It is very strong on the released files because Task 3 contains full valid routes matching every Task 1/2 partial; this is not a normal generalization claim.
...
to `solutions/solution_13_transductive_generator_validator/outputs/`.
